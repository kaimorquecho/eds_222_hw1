...
#### __Answer:__
The implicit assumption about file organization in the code above is that I will keep my data inside my working directory, in a folder called "data", and that this rproj will be my working directory. 
...
crowdsourced %>%  
  summarize(min(PM), na.rm = TRUE) 

crowdsourced %>%
  summarize(max(PM), na.rm = TRUE) 
```
